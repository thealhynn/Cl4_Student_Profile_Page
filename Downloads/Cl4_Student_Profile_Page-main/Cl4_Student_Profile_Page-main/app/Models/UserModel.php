...
class UserModel extends Model
{
    ...
    {
        return $this->db->table('users u')
            ->select('u.id, u.fullname, u.username, u.student_id, u.course, u.year_level, u.section, u.phone, u.address, u.created_at, r.name AS role_name, r.label AS role_label')
            ->join('roles r', 'r.id = u.role', 'left')
